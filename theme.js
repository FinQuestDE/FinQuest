...
/* ════════ COMPONENT TOKEN OVERRIDES (clean theme) ════════
   Diese Variablen werden von components.js genutzt.
   Alle Inline-Styles und CSS-Klassen in components.js
...
`;
  ...
  function buildThemeSection() {
    ...
    section.style.cssText = 'background:var(--fq-section-bg);border:1px solid var(--fq-section-border);border-radius:16px;padding:18px 20px;margin-top:0';

    section.innerHTML = `
      <div class="fq-set-stitle" style="margin-bottom:14px">
        🎨 Design-Modus
      </div>
