...
/* ════════ CSS-VARIABLEN-OVERRIDES (CLEAN THEME) ════════
   Diese Block überschreibt ALLE :root-Variablen aus finquest.html,
   dashboard.html und components.js. CSS-Klassen und Inline-Styles
   referenzieren nur noch diese Tokens → kein !important nötig.
═══════════════════════════════════════════════════════════════ */
html[data-theme="clean"] {
  ...
  --color-text-main: #1A1523;
  --color-text-muted: #6B6578;
  --color-border: rgba(124,58,237,0.15);
  --color-xp-bg: #F0EDE8;
  --color-footer: #F0EDE8;

  /* ── Strukturelle Tokens finquest.html ── */
  --color-navbar-bg: rgba(255,255,255,0.88);
  --color-overlay: rgba(26,21,35,0.5);
  --color-subtle-border: rgba(124,58,237,0.1);
  --color-card-border: rgba(124,58,237,0.1);
  --color-divider: rgba(124,58,237,0.1);
  --color-footer-bottom: #9E98AA;
  --color-marquee-bg: rgba(124,58,237,0.05);
  --color-marquee-border: rgba(124,58,237,0.12);
  --color-btn-ghost-border: rgba(124,58,237,0.2);
  --color-btn-outline-border: rgba(124,58,237,0.2);

  /* ── Strukturelle Tokens dashboard.html ── */
  --navbar-bg: rgba(255,255,255,0.88);
  --subtle-border: rgba(124,58,237,0.1);
  --card-border: rgba(124,58,237,0.1);
  --overlay-bg: rgba(26,21,35,0.5);
  --dd-hover: #FAF7FF;
  --dd-sep: #F0EDE8;

  /* ── components.js tokens ── */
  --fq-nav-bg: rgba(255,255,255,0.88);
  --fq-nav-border: rgba(124,58,237,0.08);
  --fq-pill-bg: #ffffff;
  --fq-pill-border: rgba(124,58,237,0.2);
  --fq-pill-color: #1A1523;
  --fq-dd-bg: #ffffff;
  --fq-dd-border: rgba(124,58,237,0.1);
  --fq-dd-color: #3D3452;
  --fq-dd-muted: #9E98AA;
  --fq-dd-sep: #F0EDE8;
  --fq-dd-hover: #FAF7FF;
  --fq-modal-bg: #ffffff;
  --fq-modal-border: rgba(124,58,237,0.1);
  --fq-modal-color: #1A1523;
  --fq-section-bg: #FAF7FF;
  --fq-section-border: rgba(124,58,237,0.12);
  --fq-input-bg: #ffffff;
  --fq-input-border: rgba(124,58,237,0.15);
  --fq-input-color: #1A1523;
  --fq-mobile-bg: #ffffff;
  --fq-mobile-border: rgba(124,58,237,0.15);
  --fq-mobile-color: #1A1523;
  --fq-footer-bg: #F0EDE8;
  --fq-footer-color: #6B6578;
  --fq-footer-heading: #1A1523;
}
